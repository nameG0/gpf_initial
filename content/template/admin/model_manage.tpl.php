...
<td class="align_c">
<a href="<?=admin_url(".model_field.manage.&modelid={$info['modelid']}")?>">字段管理</a> | 
...
<a href=javascript:confirmurl("<?=admin_url("..delete.&modelid={$info['modelid']}")?>","确认要删除‘<?=str_replace(' ','&nbsp;',$info['name'])?>’模型吗？")>删除</a> | 
