...
require_once CATEGORY_ROOT . 'include/category.class.php';
	...
	//{{{
		if(count($CATEGORY) < 50)
		{
			...
			$str = "<tr>
				...
				<td class='align_c'>\$add_child_cat | <a href='?id=\$mod,\$file,edit&catid=\$id&parentid=\$parentid'>".$LANG['edit']."</a> | \$move_content | \$clear_cat | <a href=javascript:confirmurl('?mod=\$mod&file=\$file&action=delete&catid=\$id','确认删除{\$name}栏目吗？') >".$LANG['delete']."</a></td>
				</tr>";
			$tree->tree($categorys);
