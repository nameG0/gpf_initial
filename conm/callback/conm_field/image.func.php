 ...
 * @filesource
 */
function cm_ft_conm__image_sql($set, $rdb_type = NULL)
{//{{{
...
function cm_ft_conm__image_FString($set)
{//{{{
	if(!$set['maxlength']) $set['maxlength'] = 255;
	$maxlength = min($set['maxlength'], 255);
...
function cm_ft_conm__image_input()
{//{{{
	
}//}}}

function cm_ft_conm__image_update()
{//{{{
	
}//}}}

function cm_ft_conm__image_search_form($field, $value, $fieldinfo)
{//{{{
	return form::text($field, $field, $value, 'text', 20);
}//}}}

function cm_ft_conm__image_search($field, $value)
{//{{{
	return $value === '' ? '' : " `$field` LIKE '%$value%' ";
}//}}}

function cm_ft_conm__image_output($field, $value)
{//{{{
