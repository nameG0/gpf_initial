 ...
 * @filesource
 */
function cm_ft_conm__posid_sql($set, $rdb_type = NULL)
{//{{{
...
function cm_ft_conm__posid_form($field, $value, $fieldinfo)
{//{{{
	global $catid;
	extract($fieldinfo);
...
function cm_ft_conm__posid_input()
{//{{{
	
}//}}}

function cm_ft_conm__posid_update()
{//{{{
	
}//}}}

function cm_ft_conm__posid_search_form($field, $value, $fieldinfo)
{//{{{
	return form::text($field, $field, $value, 'text', 20);
}//}}}

function cm_ft_conm__posid_search($field, $value)
{//{{{
	return $value === '' ? '' : " `$field` LIKE '%$value%' ";
}//}}}

function cm_ft_conm__posid_output($field, $value)
{//{{{
