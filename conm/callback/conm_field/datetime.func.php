 ...
 * @filesource
 */
function cm_ft_conm__datetime_sql($set, $rdb_type = NULL)
{//{{{
...
function cm_ft_conm__datetime_input()
{//{{{
	
}//}}}

function cm_ft_conm__datetime_update()
{//{{{
	
}//}}}

function cm_ft_conm__datetime_search_form($field, $value, $fieldinfo)
{//{{{
	return form::text($field, $field, $value, 'text', 20);
}//}}}

function cm_ft_conm__datetime_search($field, $value)
{//{{{
	return $value === '' ? '' : " `$field` LIKE '%$value%' ";
}//}}}

function cm_ft_conm__datetime_output($field, $value)
{//{{{
