...
require PHPCMS_ROOT . 'include/dir.func.php';
require PHPCMS_ROOT . 'include/url.func.php';
require PHPCMS_ROOT . 'include/output.class.php';
require PHPCMS_ROOT . 'include/priv_group.class.php';
require PHPCMS_ROOT . 'include/times.class.php';
...
define('SKIN_PATH', S_URL . 'pc8/skins/'.TPL_CSS.'/');
...
if($PHPCMS['publish']) {
	...
	if(isset($tmp_contentid)) {
		require_once PHPCMS_ROOT . 'include/admin/content.class.php';
		require_once PHPCMS_ROOT . 'include/attachment.class.php';
