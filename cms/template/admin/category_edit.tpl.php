...
<tr>
  ...
  <tbody id='Tabs3' style='display:none'>
   ...
   <tbody id='Tabs4' style='display:none'>
    <tr>
      <th width='30%'><strong>栏目首页模板(模块,模板)</strong></th>
      <td>
      <input type="text" name="setting[template_category]" value="<?=$template_category?>" />
      </td>
    </tr>
    <tr>
      <th><strong>栏目列表页模板</strong></th>
      <td>
      <input type="text" name="setting[template_list]" value="<?=$template_list?>" />
      </td>
    </tr>
    <tr>
      <th><strong>内容页模板</strong></th>
      <td>
      <input type="text" name="setting[template_show]" value="<?=$template_show?>" />
      </td>
    </tr>
	<tr>
      <th><strong>打印页模板</strong></th>
      <td>
      <input type="text" name="setting[template_print]" value="<?=$template_print?>" />
      </td>
    </tr>
	<tr>
